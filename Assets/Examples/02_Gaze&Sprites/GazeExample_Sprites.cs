...
namespace iView_Example
{
    ...
    public class GazeExample_Sprites : MonoBehaviour
    {
        ...
        /// <summary>
        /// cast a ray into the Scene using the 2DPhysicsUtilities. call function from another example Class (gazeSelectableItem)
        /// </summary>
        private void RayCast2DSprite()
        {
            ...
            if (hit.collider != null)
            {
                ...
                hit.collider.gameObject.GetComponent<GazeSelectableItem>().OnGazeEnter(selectedScaleFactor);
            }
