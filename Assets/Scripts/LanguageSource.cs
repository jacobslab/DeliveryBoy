...
public static class LanguageSource
{
    ...
    private static Dictionary<string, string[]> language_string_dict = new Dictionary<string, string[]>()
    {
        ...
        { "store cue recall", new string[] {"Please recall which object you delivered to the store shown on the screen. \n Press any button to continue.", "Recallen"} },
        ...
        { "rating improved", new string[] {"Your rating improved!", "Das ist good!"} },
        ...
        { "end message", new string[] {"Congratulations, you finished delivery-ing objects!  The game is over.  Your cumulative score: ", "Kongratulashunst!!  Zie overs Givenallziethingst!  Zie points: "} },
